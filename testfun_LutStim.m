...
function f=testfun_LutStim(t,y,Tovu,Follicles,para,paraOde,Par,dd1)%[f NumFoll MaxSize]
...
if Par(596) > 0 && t > Par(599) 
    ...
    for i = 1:n
         ...
         dt = Par(599) + i - 1 ;
         h = ((Par(576)*(Par(575)^2))/((Par(575)-Par(574))^2)) ...
                    * [exp(-Par(575)*(t-dt)) * (Par(574)*(t-dt) ...
                    -Par(575)*(t-dt)-1)+exp(-Par(574)*(t-dt))];    
         H = H + h;
    end 
     
    f(NumFollicles+34)=y(NumFollicles+34)-H; 
